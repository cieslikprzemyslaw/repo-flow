...
$privateFiles = @(
    ...
    'PreCommit.ps1',
    'PullRequests.ps1',
    'ReviewContract.Serialization.ps1',
    'ReviewContract.Validation.ps1',
    'ReviewContract.Matching.ps1',
    'ReviewContract.Comments.ps1',
    'ReviewTransport.Context.ps1',
    'ReviewTransport.GitHub.ps1',
    'ReviewTransport.Selection.ps1',
    'ReviewTransport.State.ps1',
    'ReviewTransport.Workflow.ps1',
    'ReviewLoop.Configuration.ps1',
    'ReviewLoop.Result.ps1',
    'ReviewLoop.Prompt.ps1',
    'ReviewLoop.Ci.ps1',
    'ReviewLoop.Repair.ps1',
    'ReviewLoop.Workflow.ps1',
    'ReviewFeedback.ps1',
    'CiContext.ps1',
    'Ci.ps1',
    'PrRepair.ps1',
